...
# Tinggal pakai
userId, ktpUrl, selfieUrl = input().split()
  ...
  for word in extract.split("\n"):
    ...
    if re.search(r'[A-Z]+[A-Z]+[,.]', word):
      ...
      try:
        ...
        dict_ktp['birth_date'] = ' '.join([str(elem) for elem in arr])
...
def add_data(data):
    ...
    # Add a new data
    user_data = db.collection(u'users').document(userId).set(data[0], merge=True)
